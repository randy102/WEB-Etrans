...
<div class="row">
	<div class="col-md-12">
		<ul class="breadcrumb">
			...
			<li class="active"><i class="fa fa-pencil fa-fw"></i> Sửa bài dịch</li>
		</ul>
	</div>
</div>
...
<div class="row">
	<div class="col-md-10">
		<form method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				<label>DVD</label>
				<input type="number" name="dvd" class="form-control" value="<?php if(isset($_POST['dvd'])) echo $_POST['dvd']; else echo $result['dvd']; ?>">
			</div>

			<div class="form-group">
				<label>Ảnh bìa</label><br>
				<img class="img-thumbnail" src="/img/trans/<?php echo $result['img']; ?>">
			</div>
...
if(isset($_POST['submit'])){
	...
	if($_FILES['img']['name']){
		...
		$file_path = "../img/trans/".$result['img'];
		...
		$sql = "UPDATE trans SET eng_title = '$e_title_r', eng_cont = '$e_cont_r', vi_title='$v_title_r', vi_cont='$v_cont_r', dvd='$dvd', img='$img_name_r' WHERE id='$id'";
	}

	else $sql = "UPDATE trans SET eng_title = '$e_title_r', eng_cont = '$e_cont_r', vi_title='$v_title_r', vi_cont='$v_cont_r', dvd='$dvd' WHERE id='$id'";
