<?php
	...
	$sql = "SELECT * FROM post INNER JOIN kinds ON post.kind_id = kinds.kind_id ORDER BY id DESC LIMIT $first, $max_unit";
...
<div class="row">
	<div class="col-md-12">
		<ul class="breadcrumb">
			...
			<li class="active"><i class="fa fa-fw fa-pencil"></i> Bài viết</li>
		</ul>
	</div>
</div>
		...
		<table class="table table-hover table-striped trans-list">
			...
			<tbody>
				...
				<tr>
					...
					<td><?php echo $result['kind_name'] ?></td>
					<td><?php echo $result['date'] ?></td>
					<td>
						<a class=delete href="/admin/delete.php?t=post&id=<?php echo $result['id']; ?>"><i class="fa fa-fw fa-trash"></i> Xóa</a> 
						<a href="/admin/index.php?url=post-edit&id=<?php echo $result['id']; ?>"><i class="fa fa-fw fa-pencil"></i> Sửa</a>
					</td>
				</tr>
				<?php } ?>
			</tbody>
...
<div class="row">
	<div class="col-md-12">
		<a href="/admin/index.php?url=post-add" class="btn btn-default btn-md"><i class="fa fa-fw fa-plus"></i> Đăng bài</a>
	</div>
</div>
